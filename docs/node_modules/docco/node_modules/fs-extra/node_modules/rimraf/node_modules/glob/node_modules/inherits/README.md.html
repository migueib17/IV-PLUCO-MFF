...
<head>
  ...
  <title>. documentation: node_modules/docco/node_modules/fs-extra/node_modules/rimraf/node_modules/glob/node_modules/inherits/README.md</title>
  ...
  <div id="footer">
    ...
    <div id="jump_wrapper">
      <div id="jump_page">
          ...
          <a class="source source-2" href="#note-on-version-~1.0"> note on version ~1.0</a>
      </div>
    </div>
    </div>
...
<div class="codehilite"><pre><span class="kd">var</span> <span class="nx">inherits</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;inherits&#39;</span><span class="p">);</span>
<span class="c1">// then use exactly as the standard one</span>
</pre></div>


<h2><a id="note-on-version-~1.0" class="header-anchor" href="#note-on-version-~1.0"> note on version ~1.0</a></h2>
