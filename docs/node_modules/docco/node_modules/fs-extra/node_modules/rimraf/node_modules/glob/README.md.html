...
<head>
  ...
  <title>. documentation: node_modules/docco/node_modules/fs-extra/node_modules/rimraf/node_modules/glob/README.md</title>
...
<div id='container' class="documentation">
  <div id="footer">
    ...
    <div id="jump_wrapper">
      <div id="jump_page">
          <a class="source source-1" href="#glob"> Glob</a>
          <a class="source source-2" href="#usage"> Usage</a>
          <a class="source source-2" href="#glob-primer"> Glob Primer</a>
          <a class="source source-3" href="#dots"> Dots</a>
          <a class="source source-3" href="#basename-matching"> Basename Matching</a>
          <a class="source source-3" href="#negation"> Negation</a>
          <a class="source source-3" href="#empty-sets"> Empty Sets</a>
          <a class="source source-3" href="#see-also:"> See Also:</a>
          <a class="source source-2" href="#glob.hasmagic(pattern,-[options])"> glob.hasMagic(pattern, [options])</a>
          <a class="source source-2" href="#glob(pattern,-[options],-cb)"> glob(pattern, [options], cb)</a>
          <a class="source source-2" href="#glob.sync(pattern,-[options])"> glob.sync(pattern, [options])</a>
          <a class="source source-2" href="#class:-glob.glob"> Class: glob.Glob</a>
          <a class="source source-3" href="#new-glob.glob(pattern,-[options],-[cb])"> new glob.Glob(pattern, [options], [cb])</a>
          <a class="source source-3" href="#properties"> Properties</a>
          <a class="source source-3" href="#events"> Events</a>
          <a class="source source-3" href="#methods"> Methods</a>
          <a class="source source-3" href="#options"> Options</a>
          <a class="source source-2" href="#comparisons-to-other-fnmatch/glob-implementations"> Comparisons to other fnmatch/glob implementations</a>
          <a class="source source-3" href="#comments-and-negation"> Comments and Negation</a>
          <a class="source source-2" href="#windows"> Windows</a>
          <a class="source source-2" href="#race-conditions"> Race Conditions</a>
  ...
  <div id="everything" class='clearall'>
    ...
    <section>
        <div class='docs'>
          ...
          <p><a href="https://travis-ci.org/isaacs/node-glob/"><img alt="Build Status" src="https://travis-ci.org/isaacs/node-glob.svg?branch=master" /></a> <a href="https://david-dm.org/isaacs/node-glob"><img alt="Dependency Status" src="https://david-dm.org/isaacs/node-glob.svg" /></a> <a href="https://david-dm.org/isaacs/node-glob#info=devDependencies"><img alt="devDependency Status" src="https://david-dm.org/isaacs/node-glob/dev-status.svg" /></a> <a href="https://david-dm.org/isaacs/node-glob#info=optionalDependencies"><img alt="optionalDependency Status" src="https://david-dm.org/isaacs/node-glob/optional-status.svg" /></a></p>
<h1><a id="glob" class="header-anchor" href="#glob"> Glob</a></h1>
...
<h2><a id="usage" class="header-anchor" href="#usage"> Usage</a></h2>
<div class="codehilite"><pre><span class="kd">var</span> <span class="nx">glob</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;glob&quot;</span><span class="p">)</span>
...
<h2><a id="glob-primer" class="header-anchor" href="#glob-primer"> Glob Primer</a></h2>
...
<h3><a id="dots" class="header-anchor" href="#dots"> Dots</a></h3>
...
<h3><a id="basename-matching" class="header-anchor" href="#basename-matching"> Basename Matching</a></h3>
...
<h3><a id="negation" class="header-anchor" href="#negation"> Negation</a></h3>
...
<h3><a id="empty-sets" class="header-anchor" href="#empty-sets"> Empty Sets</a></h3>
<p>If no matching files are found, then an empty array is returned.  This
differs from the shell, where the pattern itself is returned.  For
example:</p>
<div class="codehilite"><pre><span class="nv">$ </span><span class="nb">echo </span>a*s*d*f
a*s*d*f
</pre></div>


<p>To get the bash-style behavior, set the <code>nonull:true</code> in the options.</p>
<h3><a id="see-also:" class="header-anchor" href="#see-also:"> See Also:</a></h3>
<ul>
...
<h2><a id="glob.hasmagic(pattern,-[options])" class="header-anchor" href="#glob.hasmagic(pattern,-[options])"> glob.hasMagic(pattern, [options])</a></h2>
...
options.</p>
<h2><a id="glob(pattern,-[options],-cb)" class="header-anchor" href="#glob(pattern,-[options],-cb)"> glob(pattern, [options], cb)</a></h2>
<ul>
<li><code>pattern</code> {String} Pattern to be matched</li>
<li><code>options</code> {Object}</li>
<li><code>cb</code> {Function}</li>
...
<h2><a id="glob.sync(pattern,-[options])" class="header-anchor" href="#glob.sync(pattern,-[options])"> glob.sync(pattern, [options])</a></h2>
<ul>
<li><code>pattern</code> {String} Pattern to be matched</li>
<li><code>options</code> {Object}</li>
...
<h2><a id="class:-glob.glob" class="header-anchor" href="#class:-glob.glob"> Class: glob.Glob</a></h2>
<p>Create a Glob object by instantiating the <code>glob.Glob</code> class.</p>
<div class="codehilite"><pre><span class="kd">var</span> <span class="nx">Glob</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">&quot;glob&quot;</span><span class="p">).</span><span class="nx">Glob</span>
...
immediately.</p>
<h3><a id="new-glob.glob(pattern,-[options],-[cb])" class="header-anchor" href="#new-glob.glob(pattern,-[options],-[cb])"> new glob.Glob(pattern, [options], [cb])</a></h3>
<ul>
<li><code>pattern</code> {String} pattern to search for</li>
<li><code>options</code> {Object}</li>
<li><code>cb</code> {Function} Called when an error occurs, or matches are found</li>
<li><code>err</code> {Error | null}</li>
<li><code>matches</code> {Array<String>} filenames found matching the pattern</li>
</ul>
...
<h3><a id="properties" class="header-anchor" href="#properties"> Properties</a></h3>
<ul>
...
<h3><a id="events" class="header-anchor" href="#events"> Events</a></h3>
<ul>
...
<h3><a id="methods" class="header-anchor" href="#methods"> Methods</a></h3>
<ul>
...
<h3><a id="options" class="header-anchor" href="#options"> Options</a></h3>
...
<h2><a id="comparisons-to-other-fnmatch/glob-implementations" class="header-anchor" href="#comparisons-to-other-fnmatch/glob-implementations"> Comparisons to other fnmatch/glob implementations</a></h2>
...
<h3><a id="comments-and-negation" class="header-anchor" href="#comments-and-negation"> Comments and Negation</a></h3>
<p><strong>Note</strong>: In version 5 of this module, negation and comments are
...
<h2><a id="windows" class="header-anchor" href="#windows"> Windows</a></h2>
...
<h2><a id="race-conditions" class="header-anchor" href="#race-conditions"> Race Conditions</a></h2>
...
<div class="codehilite"><pre># <span class="nt">&lt;a</span> <span class="na">id=</span><span class="s">&quot;to-run-tests&quot;</span> <span class="na">class=</span><span class="s">&quot;header-anchor&quot;</span> <span class="na">href=</span><span class="s">&quot;#to-run-tests&quot;</span><span class="nt">&gt;</span> to run tests<span class="nt">&lt;/a&gt;</span>
npm test

# <span class="nt">&lt;a</span> <span class="na">id=</span><span class="s">&quot;to-re-generate-test-fixtures&quot;</span> <span class="na">class=</span><span class="s">&quot;header-anchor&quot;</span> <span class="na">href=</span><span class="s">&quot;#to-re-generate-test-fixtures&quot;</span><span class="nt">&gt;</span> to re-generate test fixtures<span class="nt">&lt;/a&gt;</span>
npm run test-regen

# <span class="nt">&lt;a</span> <span class="na">id=</span><span class="s">&quot;to-benchmark-against-bash/zsh&quot;</span> <span class="na">class=</span><span class="s">&quot;header-anchor&quot;</span> <span class="na">href=</span><span class="s">&quot;#to-benchmark-against-bash/zsh&quot;</span><span class="nt">&gt;</span> to benchmark against bash/zsh<span class="nt">&lt;/a&gt;</span>
npm run bench

# <span class="nt">&lt;a</span> <span class="na">id=</span><span class="s">&quot;to-profile-javascript&quot;</span> <span class="na">class=</span><span class="s">&quot;header-anchor&quot;</span> <span class="na">href=</span><span class="s">&quot;#to-profile-javascript&quot;</span><span class="nt">&gt;</span> to profile javascript<span class="nt">&lt;/a&gt;</span>
npm run prof
</pre></div>
        </div>
        <div class='code'>
