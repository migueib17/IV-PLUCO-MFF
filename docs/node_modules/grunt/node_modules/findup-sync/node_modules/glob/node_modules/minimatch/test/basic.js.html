...
<head>
  ...
  <title>. documentation: node_modules/grunt/node_modules/findup-sync/node_modules/glob/node_modules/minimatch/test/basic.js</title>
...
<span class="kd">var</span> <span class="nx">patterns</span> <span class="o">=</span>
  <span class="p">[</span> <span class="s2">&quot;http://www.bashcookbook.com/bashinfo/source/bash-1.14.7/tests/glob-test&quot;</span>
  ...
  <span class="p">,</span> <span class="p">[</span><span class="s2">&quot;*.!(js)&quot;</span><span class="p">,</span> <span class="p">[</span><span class="s2">&quot;foo.bar&quot;</span><span class="p">,</span> <span class="s2">&quot;foo.&quot;</span><span class="p">,</span> <span class="s2">&quot;boo.js.boo&quot;</span><span class="p">]</span> <span class="p">]</span></pre></div>
    ...
    <section>
        <div class='docs'>
          ...
          <p><a href="https://github.com/isaacs/minimatch/issues/5">https://github.com/isaacs/minimatch/issues/5</a></p>
        </div>
        <div class='code'>
          <div class="highlight"><pre>  <span class="p">,</span> <span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
      <span class="nx">files</span> <span class="o">=</span> <span class="p">[</span> <span class="s1">&#39;a/b/.x/c&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/b/.x/c/d&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/b/.x/c/d/e&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/b/.x&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/b/.x/&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/.x/b&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;.x&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;.x/&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;.x/a&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;.x/a/b&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;a/.x/b/.x/c&#39;</span>
              <span class="p">,</span> <span class="s1">&#39;.x/.x&#39;</span> <span class="p">]</span>
  <span class="p">}</span>
  <span class="p">,</span> <span class="p">[</span><span class="s2">&quot;**/.x/**&quot;</span><span class="p">,</span> <span class="p">[</span> <span class="s1">&#39;.x/&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;.x/a&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;.x/a/b&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;a/.x/b&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;a/b/.x/&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;a/b/.x/c&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;a/b/.x/c/d&#39;</span>
                 <span class="p">,</span> <span class="s1">&#39;a/b/.x/c/d/e&#39;</span> <span class="p">]</span> <span class="p">]</span>

  <span class="p">]</span>

<span class="kd">var</span> <span class="nx">regexps</span> <span class="o">=</span>
  <span class="p">[</span> <span class="s1">&#39;/^(?:(?=.)a[^/]*?)$/&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;/^(?:\\/\\^root:\\/\\{s\\/(?=.)\\^[^:][^/]*?:[^:][^/]*?:\\([^:]\\)[^/]*?\\.[^/]*?\\$\\/1\\/)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:\\/\\^root:\\/\\{s\\/(?=.)\\^[^:][^/]*?:[^:][^/]*?:\\([^:]\\)[^/]*?\\.[^/]*?\\$\\/\u0001\\/)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[a-c]b[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[a-y][^/]*?[^c])$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^c])$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[X-]b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^a-c][^/]*?)$/&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?\\/(?=.)man[^/]*?\\/(?=.)bash\\.[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:man\\/man1\\/bash\\.1)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/]*?c)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/]c)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/][^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/][^/])$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/][^/])$/&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?c)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/]*?[^/])$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?cd[^/]*?[^/]*?[^/][^/]*?[^/]*?[^/][^/]k)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/][^/]*?[^/]*?cd[^/]*?[^/]*?[^/][^/]*?[^/]*?[^/][^/]k)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/][^/]*?[^/]*?cd[^/]*?[^/]*?[^/][^/]*?[^/]*?[^/][^/]k[^/]*?[^/]*?[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/][^/]*?[^/]*?cd[^/]*?[^/]*?[^/][^/]*?[^/]*?[^/][^/][^/]*?[^/]*?[^/]*?k)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]*?[^/]*?[^/][^/]*?[^/]*?cd[^/]*?[^/]*?[^/][^/]*?[^/]*?[^/][^/][^/]*?[^/]*?[^/]*?k[^/]*?[^/]*?)$/&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;/^(?:\\[\\])$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:\\[abc)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)XYZ)$/i&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)ab[^/]*?)$/i&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[ia][^/][ck])$/i&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:\\/(?!\\.)(?=.)[^/]*?|(?!\\.)(?=.)[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:\\/(?!\\.)(?=.)[^/]|(?!\\.)(?=.)[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?:(?!(?:\\/|^)\\.).)*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a\\/(?!(?:^|\\/)\\.{1,2}(?:$|\\/))(?=.)[^/]*?\\/b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a\\/(?=.)\\.[^/]*?\\/b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a\\/(?!\\.)(?=.)[^/]*?\\/b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a\\/(?=.)\\.[^/]*?\\/b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?\\(a\\/b\\))$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)(?:a|b)*|(?!\\.)(?=.)(?:a|c)*)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)\\[(?=.)\\!a[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)\\[(?=.)#a[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)\\+\\(a\\|[^/]*?\\|c\\\\\\\\\\|d\\\\\\\\\\|e\\\\\\\\\\\\\\\\\\|f\\\\\\\\\\\\\\\\\\|g)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)(?:a|b)*|(?!\\.)(?=.)(?:a|c)*)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a|(?!\\.)(?=.)[^/]*?\\(b\\|c|d\\))$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:a|(?!\\.)(?=.)(?:b|c)*|(?!\\.)(?=.)(?:b|d)*)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)(?:a|b|c)*|(?!\\.)(?=.)(?:a|c)*)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?!\\.)(?=.)[^/]*?\\(a\\|b\\|c\\)|(?!\\.)(?=.)[^/]*?\\(a\\|c\\))$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)a[^/]b)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?:(?=.)#[^/]*?)$/&#39;</span><span class="p">,</span>
    <span class="s1">&#39;/^(?!^(?:(?=.)a[^/]*?)$).*$/&#39;</span><span class="p">,</span>
    ...
    <span class="s1">&#39;/^(?:(?:(?!(?:\\/|^)\\.).)*?\\/\\.x\\/(?:(?!(?:\\/|^)\\.).)*?)$/&#39;</span> <span class="p">]</span>
<span class="kd">var</span> <span class="nx">re</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span></pre></div>
        </div>
        <div class='clearall'></div>
    </section>
    </div>
  ...
  <span class="kd">var</span> <span class="nx">start</span> <span class="o">=</span> <span class="nb">Date</span><span class="p">.</span><span class="nx">now</span><span class="p">()</span></pre></div>
    ...
    <section>
        ...
        <div class='code'>
          <div class="highlight"><pre>  <span class="nx">patterns</span><span class="p">.</span><span class="nx">forEach</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">c</span><span class="p">)</span> <span class="p">{</span>
    ...
    <span class="kd">var</span> <span class="nx">pattern</span> <span class="o">=</span> <span class="nx">c</span><span class="p">[</span><span class="mi">0</span><span class="p">]</span>
      ...
      <span class="p">,</span> <span class="nx">options</span> <span class="o">=</span> <span class="nx">c</span><span class="p">[</span><span class="mi">2</span><span class="p">]</span> <span class="o">||</span> <span class="p">{}</span>
    ...
    <section>
        ...
        <div class='code'>
          <div class="highlight"><pre>    <span class="kd">var</span> <span class="nx">m</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">mm</span><span class="p">.</span><span class="nx">Minimatch</span><span class="p">(</span><span class="nx">pattern</span><span class="p">,</span> <span class="nx">options</span><span class="p">)</span>
    ...
    <span class="kd">var</span> <span class="nx">expectRe</span> <span class="o">=</span> <span class="nx">regexps</span><span class="p">[</span><span class="nx">re</span><span class="o">++</span><span class="p">]</span>
    ...
    <span class="nx">t</span><span class="p">.</span><span class="nx">equal</span><span class="p">(</span><span class="nx">tapOpts</span><span class="p">.</span><span class="nx">re</span><span class="p">,</span> <span class="nx">expectRe</span><span class="p">,</span> <span class="nx">tapOpts</span><span class="p">)</span>
  <span class="p">})</span>
